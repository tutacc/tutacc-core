...
func init() {
	proto.RegisterType((*Config)(nil), "tutacc.core.transport.internet.quic.Config")
}

func init() {
	proto.RegisterFile("github.com/tutacc/tutacc-core/transport/internet/quic/config.proto", fileDescriptor_462e2eb906061b36)
}
